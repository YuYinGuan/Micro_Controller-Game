...
#define CapSense_CSD_MULTIPLE_PRESCALER_ENABLED (0u)
...
/* Measure REGs  definitions */
    ...
    #if (CY_PSOC5A)
        #define CapSense_CSD_PWM_CH0_CONTROL2_REG   (*(reg8 *) CapSense_CSD_MeasureCH0_FF_Window__CFG1 )
        #define CapSense_CSD_PWM_CH0_CONTROL2_PTR   ( (reg8 *) CapSense_CSD_MeasureCH0_FF_Window__CFG1 )
    #else
    ...
    #if (CY_PSOC5A)
        #define CapSense_CSD_RAW_CH0_CONTROL2_REG   (*(reg8 *) CapSense_CSD_MeasureCH0_FF_Counter__CFG1 )
        #define CapSense_CSD_RAW_CH0_CONTROL2_PTR   ( (reg8 *) CapSense_CSD_MeasureCH0_FF_Counter__CFG1 )
    #else
    ...
    #define CapSense_CSD_RAW_CH0_AUX_CONTROL_PTR     ( (reg8 *) \
        ...
        #if (CY_PSOC5A)
            #define CapSense_CSD_PWM_CH1_CONTROL2_REG   (*(reg8 *) CapSense_CSD_MeasureCH1_FF_Window__CFG1 )
            #define CapSense_CSD_PWM_CH1_CONTROL2_PTR   ( (reg8 *) CapSense_CSD_MeasureCH1_FF_Window__CFG1 )
        #else
        ...
        #if (CY_PSOC5A)
            #define CapSense_CSD_RAW_CH1_CONTROL2_REG   (*(reg8 *) CapSense_CSD_MeasureCH1_FF_Counter__CFG1 )
            #define CapSense_CSD_RAW_CH1_CONTROL2_PTR   ( (reg8 *) CapSense_CSD_MeasureCH1_FF_Counter__CFG1 )
        #else
...
#if (CY_PSOC5A)
    #define CapSense_CSD_PRESCALER_CTRL_CMP_MODE_SHIFT  (0x01u)
#else
...
#if (CY_PSOC5A)
    #define CapSense_CSD_MEASURE_CTRL_MODE_SHIFT        (0x01u)
#else
