...
/* Helps while centroid calulation */
    ...
    static uint8 CapSense_CSD_centroid[3];
#endif  /* (CapSense_CSD_TOTAL_CENTROIDS_COUNT) */

const uint8 CYCODE CapSense_CSD_fingerThreshold[] = {
    100u, 100u, 100u, 
};

const uint8 CYCODE CapSense_CSD_noiseThreshold[] = {
    20u, 20u, 20u, 
};

const uint8 CYCODE CapSense_CSD_hysteresis[] = {
    0u, 10u, 10u, 
};
                                 ...
                                 
{
    ...
    uint8 widget = CapSense_CSD_widgetNumber[sensor];
    uint8 noiseThreshold = CapSense_CSD_noiseThreshold[widget];
                                  ...
                                  
{
    ...
    uint8 widget = CapSense_CSD_widgetNumber[sensor];
    uint8 fingerThreshold = CapSense_CSD_fingerThreshold[widget];
    uint8 hysteresis = CapSense_CSD_hysteresis[widget];
                                    ...
                                    
{
    ...
    *******************************************************************************/
        ...
        uint8 CapSense_CSD_FindMaximum(uint8 offset, uint8 count, uint8 fingerThreshold, const uint8 CYCODE *diplex)
