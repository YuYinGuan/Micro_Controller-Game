...
extern uint8 CapSense_CSD_noiseThreshold[];
extern uint8 CapSense_CSD_hysteresis[];

extern uint8 CapSense_CSD_widgetResolution[];

extern const uint8 CYCODE CapSense_CSD_widgetNumber[];
extern const uint8 CYCODE CapSense_CSD_numberOfSensors[];

extern uint8 CapSense_CSD_fingerThreshold[];
extern uint8 CapSense_CSD_idacSettings[];
extern uint8 CapSense_CSD_AnalogSwitchDivider[];

extern uint16 CapSense_CSD_SensorRaw[];
extern uint16 CapSense_CSD_SensorBaseline[];
extern uint8  CapSense_CSD_SensorSignal[];
...
uint8 * SMS_LIB_noiseThreshold = CapSense_CSD_noiseThreshold;
uint8 * SMS_LIB_hysteresis = CapSense_CSD_hysteresis;
...
uint8 * SMS_LIB_fingerThreshold = CapSense_CSD_fingerThreshold;
